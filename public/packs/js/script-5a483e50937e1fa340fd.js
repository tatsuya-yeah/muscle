...
window.addEventListener("load", function () {
  document.getElementById("animation-picture1 > div").classList.add("show");
  document.getElementById("animation-picture2").classList.add("show");
...
/******/ });
//# sourceMappingURL=script-5a483e50937e1fa340fd.js.map